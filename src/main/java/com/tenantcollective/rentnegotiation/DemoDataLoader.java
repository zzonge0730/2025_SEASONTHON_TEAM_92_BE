...
public class DemoDataLoader implements CommandLineRunner {
    ...
    private void loadDemoData() {
        List<Tenant> demoTenants = Arrays.asList(
            new Tenant("Happy Apt", "apartment", "monthly", "Seoul Jongno-gu Jongno 12", "Jongno-dong", "Seoul", 
            ...
            new Tenant("Green Villa", "villa", "monthly", "Seoul Gangnam-gu Teheran-ro 123", "Gangnam-dong", "Seoul", 
            ...
            new Tenant("Blue House", "villa", "monthly", "Seoul Mapo-gu Hongik-ro 45", "Hongik-dong", "Seoul", 
            ...
            new Tenant("Sunshine Tower", "apartment", "monthly", "Seoul Seongdong-gu Wangsimni-ro 78", "Wangsimni-dong", "Seoul", 
